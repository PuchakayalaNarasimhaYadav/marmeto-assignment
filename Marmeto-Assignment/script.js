...
document.querySelector(".img_list1").style.border="3px solid #8A8BA3"
const handleclickSecondImage=()=>{
  document.querySelector(".img_list2").style.border="3px solid #8A8BA3"
  document.querySelector(".img_list1").style.border="none"
  document.querySelector(".img_list3").style.border="none"
  document.querySelector(".img_list4").style.border="none"

}
const handleclickFirstImage=()=>{
  document.querySelector(".img_list1").style.border="3px solid #8A8BA3"
  document.querySelector(".img_list2").style.border="none"
  document.querySelector(".img_list3").style.border="none"
  document.querySelector(".img_list4").style.border="none"
}
const handleclickThirdImage=()=>{
  document.querySelector(".img_list3").style.border="3px solid #8A8BA3"
  document.querySelector(".img_list1").style.border="none"
  document.querySelector(".img_list2").style.border="none"
  document.querySelector(".img_list4").style.border="none"

}
const handleclickFourthImage=()=>{
  document.querySelector(".img_list4").style.border="3px solid #8A8BA3"
  document.querySelector(".img_list1").style.border="none"
  document.querySelector(".img_list2").style.border="none"
  document.querySelector(".img_list3").style.border="none"
